  ...
  <div x-show="isOpen" 
    ...
    <div class="p-6 lg:p-10">
      ...
      <form @submit.prevent="submitForm()">
        @csrf
        <h4 class="mb-6 text-lg font-medium text-gray-800 dark:text-white/90">Edit Payee</h4>
    ...
    openModal(payee) {
      ...
      if (payee) {
        this.formData = {
          ...
          kra_pin: payee.kra_pin || '',
          nssf_number: payee.nssf_number || '',
          sha_number: payee.sha_number || ''
        };
      }
