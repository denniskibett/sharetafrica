...
<div x-data="paymentDeleteModal" x-init="init()">
...
document.addEventListener('alpine:init', () => {
  Alpine.data('paymentDeleteModal', () => ({
    isOpen: false,
    paymentToDelete: null,
    message: '',
    
    init() {
      window.paymentDeleteModal = this;
    },
    
    openModal(payment) {
      this.paymentToDelete = payment;
      this.message = `Are you sure you want to delete payment from ${payment.payer_name} (${this.formatCurrency(payment.amount)})? This action cannot be undone.`;
      this.isOpen = true;
    ...
    confirmDelete() {
      if (this.paymentToDelete) {
        ...
        form.method = 'POST';
        form.action = `/payments/${this.paymentToDelete.id}`;
